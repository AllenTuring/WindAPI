...
namespace WAPIWrapperCSharp
{
    public class WindTest
    {
        ...
        {
            return "DLL Update Test Success on type " + System.Environment.OSVersion.Platform + " system";
        }
    }
    ...
    public class WindAPI
    {
        ...
        private WindDataCOM wdc = null;
        private Dictionary<ulong, WSQReq> ReqList = new Dictionary<ulong, WSQReq>();
